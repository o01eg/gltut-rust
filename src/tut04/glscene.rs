...
impl GLScene {
    ...
    pub fn new() -> GLScene {
        ...
        let program_id = glutils::load_program(
            "data/tut04/TransformVertexShader.vertexshader",
        ...
        unsafe {
            ...
            gl::BufferData(
                ...
                &G_TRIANGLE_VERTEX_BUFFER_DATA as *const _ as *const GLvoid,
                gl::STATIC_DRAW,
            );
        }
        ...
        for _ in 0..12 * 3 * 3 {
            color_buffer_data.push(rng.gen::<f32>());
        }
        ...
        unsafe {
            ...
            gl::BufferData(
                ...
                &G_TRIANGLE_COLOR_BUFFER_DATA as *const _ as *const GLvoid,
                gl::STATIC_DRAW,
            );
        }
    ...
    pub fn update(&mut self) {
        ...
        let mut rng = rand::thread_rng();
        for _ in 0..12 * 3 * 3 {
            self.color_buffer_data.push(rng.gen::<f32>());
        }
